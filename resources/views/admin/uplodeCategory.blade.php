...
@section('main-section')
    <div class="mx-auto w-full max-w-[550px] bg-white my-5">
        ...
        <form class="py-6 px-9" action="{{ $url }}" method="POST">
            @csrf
            @if ($errors->has('err'))
                <x-input label="Enter Category Name" id="cake_category" type="text" name="category_name"
                    placeholder="Enter Category Name" valuetext="{{ old('cakename') }}" redClass="border-red-500" />
            @else
                <x-input label="Enter Category Name" id="cake_category" type="text" name="category_name"
                    placeholder="Enter Category Name" valuetext="{{ isset($oldcake) ? $oldcake : '' }}"
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                        ...
                        <div class="flex flex-col ml-3">
                            ...
                            <div class="font-medium leading-none">Category Name: {{ $category->category_name }}</div>
                            </p>
                        </div>
                    </div>
                    <a href ="/category/edit/{{ $category->category_id }}"><button id ="uplodeTagEditBtn"
                    ...
                    <a href = "/category/{{ $category->category_id }}"> <button id =" Btn"
            ...
            <div class="">
                ...
                <div class="text-center p-5 flex-auto justify-center">
                    ...
                    <h2 class="text-xl font-bold py-4 ">Are you sure?</h3>
                        <p class="text-sm text-gray-500 px-8">Do you really want to delete your account? This process cannot
                            be undone</p>
                </div>
                <!--footer-->
