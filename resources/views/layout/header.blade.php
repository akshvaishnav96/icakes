...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('property/1244225.png') }}" type="image/x-icon">
    @stack('title')
        ...
        <header class="w-full text-gray-700 bg-white border-t border-gray-100 shadow-sm body-font">
            <div class="container flex flex-col flex-wrap items-center p-5 mx-auto md:flex-row">
                ...
                <nav class="flex flex-wrap items-center text-base lg:w-2/5 md:ml-auto">
                    ...
                    <a href="{{ Route('size.get') }}" class="mr-5 font-medium hover:text-gray-900">Size</a>
                    <a href="{{ Route('price.get') }}" class="mr-5 font-medium hover:text-gray-900">Price</a>
                    <a href="{{ Route('subcategory.get') }}"
                        class="mr-5 font-medium hover:text-gray-900">Subcategories</a>
                    <a href="{{ Route('flavor.get') }}" class="mr-5 font-medium hover:text-gray-900">flavor's</a>
                    <a href="{{ Route('flavorprice.get') }}"
                        class="mr-5 font-medium hover:text-gray-900">flavor's_price</a>
                    <a href="{{ Route('cakesizewithprice.get') }}"
                        class="mr-5 font-medium hover:text-gray-900">Cake_sizes</a>
